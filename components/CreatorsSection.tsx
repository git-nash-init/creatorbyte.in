...
export default function CreatorsSection() {
  ...
  return (
    <section className="bg-cream px-5 py-14 text-center md:py-20">
      ...
      <div className="mx-auto mt-6 grid max-w-4xl gap-6 sm:grid-cols-2 md:grid-cols-3">
        {creators.map((c) => (
          <a
            key={c.name}
            href={c.href}
            className="group overflow-hidden rounded-[24px] bg-white text-left shadow-[0_2px_0_rgba(32,32,32,0.06)] transition-transform hover:-translate-y-1"
          >
            ...
            <div className="p-4">
              <p className="font-heading text-lg font-bold text-ink">{c.name}</p>
